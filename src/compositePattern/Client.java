...
import compositePattern.demo.IBranch;
import compositePattern.demo.Leaf;
...
public class Client {
    ...
    private static void getAllInfo(ArrayList subordinateInfo) {
        ...
        for (int m = 0; m < len; m++) {
            ...
            if (s instanceof compositePattern.demo.Leaf) {
                System.out.println(((Leaf) s).getInfo());
            } else {
                compositePattern.demo.IBranch branch = (IBranch) s;
